...
dependencies {
    ...
    connectorNars(project(":pulsar-io:pulsar-io-jdbc:sqlite"))
    connectorNars(project(":pulsar-io:pulsar-io-jdbc:mariadb"))
    connectorNars(project(":pulsar-io:pulsar-io-jdbc:clickhouse"))
    connectorNars(project(":pulsar-io:pulsar-io-jdbc:postgres"))
    connectorNars(project(":pulsar-io:pulsar-io-jdbc:openmldb"))
    ...
    connectorNars(project(":pulsar-io:pulsar-io-debezium:mysql"))
    connectorNars(project(":pulsar-io:pulsar-io-debezium:postgres"))
    connectorNars(project(":pulsar-io:pulsar-io-debezium:oracle"))
    connectorNars(project(":pulsar-io:pulsar-io-debezium:mssql"))
    connectorNars(project(":pulsar-io:pulsar-io-debezium:mongodb"))
