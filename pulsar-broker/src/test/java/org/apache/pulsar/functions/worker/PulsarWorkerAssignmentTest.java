...
public class PulsarWorkerAssignmentTest {
    ...
    public void testFunctionAssignmentsWithRestart() throws Exception {
        ...
        functionsWorkerService.start(dlUri, new AuthenticationService(PulsarConfigurationLoader.convertFrom(workerConfig)), null, null, ErrorNotifier.getDefaultImpl());
