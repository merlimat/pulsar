...
The connectors repository uses its own version scheme, independent of Pulsar's version.
All connectors are released together as a single release (not individually), and each
release specifies which Pulsar versions it is compatible with (e.g., "connectors 1.0.0
...
This PIP is a follow-up to PIP-463 (Gradle migration), which established the build
infrastructure that makes this split straightforward.
